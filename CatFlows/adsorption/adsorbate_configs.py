...
# OH and Ox molecules
OH = Molecule(["O","H"], [[0,0,0], [-1.0, 0.0, 0.422]], site_properties={'magmom': [0.6, 0.1]})
...
NO2 = Molecule(["N", "O", "O"], [[0.01706138, 4.15418327, 5.90139358],
                       [-0.87449724,  4.72305561,  6.47843921],
                       [0.92310187, 4.50860583, 5.19279554]])
NO3 = Molecule(['N', 'O', 'O', 'O'], [[3.8414, 3.1696, 6.1981],
...
# Methanol formation
CH4 = Molecule(["C", "H", 'H', 'H', 'H'], [[2.48676400, 2.48676400, 2.48676400],
...
# Peroxide
H2O2 = Molecule(['H', 'H', 'O', 'O'], [[1.76653038, 0.81443185, 4.81451611],
