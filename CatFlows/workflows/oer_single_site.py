...
def OERSingleSite_WF(oer_dict, slab, slab_uuid, oriented_uuid, vasp_cmd=VASP_CMD, db_file=DB_FILE):
    """
    ...
    oer_single_site = Workflow(
        all_fws,
        name=f"{general_reduced_formula}-{miller_index}-OER SingleSite"
    )
